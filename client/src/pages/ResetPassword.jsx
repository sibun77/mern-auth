  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-500'>
      ...
      {!isEmailSent && <form onSubmit={onSubmitEmail}
        className='bg-slate-900 p-8 rounded-xl shadow-lg w-96 text-sm' action="">
        <h1 className='text-white text-2xl font-semibodl text-center mb-4'>Reset Password</h1>
      ...
      {!isOtpSubmited && isEmailSent && <form
        ...
        className='bg-slate-900 p-8 rounded-xl shadow-lg w-96 text-sm' action="">
        <h1 className='text-white text-2xl font-semibodl text-center mb-4'>Reset Password OTP</h1>
      ...
      {isOtpSubmited && isEmailSent && <form onSubmit={onSubmitNewPassword}
        className='bg-slate-900 p-8 rounded-xl shadow-lg w-96 text-sm' action="">
        <h1 className='text-white text-2xl font-semibodl text-center mb-4'>New Password</h1>
